...
import { CA_LEADERBOARD_PERIODS } from "../../mock/data";
...
export default function Leaderboard() {
  ...
  const data = CA_LEADERBOARD_PERIODS[month] ?? [];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-secondary mt-0.5" style={{ fontSize: 14 }}>
            Barangay rankings within {CLUSTER_INFO.label} by household waste reporting activity.
          </p>
        </div>
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="font-semibold" style={{ fontSize: 13, color: "#2E7D32" }}>
              {CLUSTER_INFO.label} — {CLUSTER_INFO.zone}
            </span>
          </div>
          <div
            className="flex items-center gap-2 rounded-full px-4 py-2"
          ...
          <div className="flex items-end gap-2">
            ...
            >
              <div className="flex flex-col items-center gap-1.5 w-full">
                ...
                <div className="text-white/80 text-center" style={{ fontSize: 11 }}>{topThree[1]?.captain ?? ""}</div>
            ...
            >
              <div className="flex flex-col items-center gap-1.5 w-full">
                ...
                <div className="text-white/80 text-center" style={{ fontSize: 11 }}>{topThree[0]?.captain ?? ""}</div>
            ...
            >
              <div className="flex flex-col items-center gap-1.5 w-full">
                ...
                <div className="text-white/80 text-center" style={{ fontSize: 11 }}>{topThree[2]?.captain ?? ""}</div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span
              ...
              style={{ fontSize: 12 }}
            >
              Full Rankings — {CLUSTER_INFO.label}
            </span>
          </div>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr style={{ background: "#F9FAFB", borderBottom: "1px solid #E5E7EB" }}>
              {["Rank", "Barangay", "Captain", "Reports", "Eco Points", "Badge"].map((h) => (
                <th
                  key={h}
