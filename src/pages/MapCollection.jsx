...
export default function MapCollection() {
  ...
  const sentAt = new Date().toLocaleTimeString("en-PH", {
    hour: "2-digit", minute: "2-digit",
  });

  // ── Route Sent Confirmation ────────────────────────────────────────────────
  if (sent) {
    return (
        ...
        >
          {!optimized ? (
            ...
            <>
              ...
              {/* Collection order */}
              <div>
                <h3 className="font-semibold text-text-primary mb-3" style={{ fontSize: 14 }}>
                  Collection Order
                </h3>
                <div className="flex flex-col gap-2">
                  {route.order.map((stop, i) => (
                    <div key={i} className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-text-primary" style={{ fontSize: 13 }}>
                          {stop.label}
                        </div>
                        {stop.street && (
