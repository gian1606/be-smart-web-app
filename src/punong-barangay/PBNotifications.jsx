        ...
        {preview ? (
          ...
          >
            ...
            <div className="flex items-center gap-4 pt-2 border-t" style={{ borderColor: "#E5E7EB" }}>
              ...
              <span className="text-text-muted" style={{ fontSize: 12 }}>
                Priority:{" "}
                <strong style={{ color: form.priority === "urgent" ? "#D32F2F" : "#6B7280" }}>
                  {form.priority}
                </strong>
              </span>
            </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                style={{
                  fontSize: 14,
                  border: formErrors.body ? "1.5px solid #D32F2F" : "1.5px solid #E5E7EB",
                  background: "#F9FAFB",
                }}
              />
              {formErrors.body && (
                <span style={{ fontSize: 12, color: "#D32F2F" }}>{formErrors.body}</span>
              )}
            </div>
            <div className="flex flex-col gap-1">
              <label className="font-medium text-text-primary" style={{ fontSize: 13 }}>
