...
import { ROUTES, CLUSTERS } from "../mock/data";
          ...
          <tbody>
            {paginated.length === 0 ? (
              ...
              paginated.map((r, i) => (
                ...
                >
                  <td className="px-4 py-3 font-semibold text-primary" style={{ fontSize: 13 }}>{r.routeId}</td>
                  <td className="px-4 py-3 text-text-secondary" style={{ fontSize: 13 }}>{r.date}</td>
                  <td className="px-4 py-3 text-text-primary" style={{ fontSize: 13 }}>{getClusterLabel(r.cluster)}</td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <button className="p-1.5 rounded-lg hover:bg-gray-100 transition-colors" title="Resend">
